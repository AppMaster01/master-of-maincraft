class ShadersData {
  final List<Shaders>? shaders;

  ShadersData({
    this.shaders,
  });

  ShadersData.fromJson(Map<String, dynamic> json)
      : shaders = (json['shaders'] as List?)?.map((dynamic e) => Shaders.fromJson(e as Map<String,dynamic>)).toList();

  Map<String, dynamic> toJson() => {
    'shaders' : shaders?.map((e) => e.toJson()).toList()
  };
}
...
class Shaders {
  ...
  Shaders.fromJson(Map<String, dynamic> json)
